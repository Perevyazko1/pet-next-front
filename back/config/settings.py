...
# Telegram — заявки на подключение приюта
TELEGRAM_SHELTER_BOT_TOKEN = os.getenv('TELEGRAM_SHELTER_BOT_TOKEN', '')
TELEGRAM_SHELTER_CHAT_ID = os.getenv('TELEGRAM_SHELTER_CHAT_ID', '')
